...
class EmailUpViewController: UIViewController {
    ...
    let emailField: UITextField = {
        ...
        field.font = Fonts.Playfair(withStyle: .italic, sizeLiteral: 16)
        return field
    }()
    ...
    let goButton: UIButton = {
        ...
        button.titleLabel?.font = Fonts.Playfair(withStyle: .italic, sizeLiteral: 16)
    ...
    func setupComponents() {
        ...
        emailField.topAnchor.constraint(equalTo: view.topAnchor, constant: 80).isActive = true
